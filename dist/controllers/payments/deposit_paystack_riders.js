...
exports.depositPaystack = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const params = {
        ...
        amount,
        reference,
        metadata: { "phone": phone, "userID": userID },
        //TODO: THIS IS NGROK
...
exports.callbackPaystack = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    paystack.transaction.verify(reference).then((response) => {
        ...
        payment.save()
            .then(() => console.log((0, ansi_colors_config_1.info)('Data saved to database')))
        ...
        if (status === 'success') {
            ...
            MySQLConnection.query(SQLCOMMAND, response.data.customer.email, function (err, result) {
                ...
                const SQLCOMMAND1 = `UPDATE users SET ACCOUNT_BALANCE = ? WHERE EMAIL LIKE ?;`;
...
exports.getBalance = function (req, res) {
    ...
    const query = 'SELECT ACCOUNT_BALANCE FROM users WHERE ID = ? AND PHONE_NUMBER = ?';
